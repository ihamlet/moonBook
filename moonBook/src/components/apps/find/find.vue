<template>
  <div class="find page-padding">
    ...
    <div class="warp">
      <div class="container">
        <van-tabs color='#0084ff' :line-width='20' :line-height='4' sticky swipeable animated v-model='indexTab' :border='false'>
...
export default {
  ...
  methods: {
    ...
    getCate(){
      ...
      if(this.$route.query.cate_id == 149 || this.$route.query.tag_id == 100 || 139){
