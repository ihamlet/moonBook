<template>
  <div class="form-parent">
    <div class="avatar-uploader">
      <van-uploader :after-read="onRead">
        <div class="prompt" v-if="!childInfo.avatar">
          <img
            v-if="childInfo.gender=='boy'"
            src="https://oss-hys.oss-cn-hangzhou.aliyuncs.com/moonBook/boy-avatar.png"
            alt="男孩默认头像"
          >
          <img
            v-else
            src="https://oss-hys.oss-cn-hangzhou.aliyuncs.com/moonBook/girl-avatar.png"
            alt="女孩默认头像"
          >
    ...
    <van-cell-group>
      ...
      />
      <van-field
        v-model="childInfo.birthday"
        input-align="right"
        readonly
        label="孩子生日"
        placeholder="请选择日期"
        :error-message="errorMessage.birthday"
        @click="isPickerShow('date')"
      />
      <van-field
        v-model="childInfo.familyTitle"
        input-align="right"
        label="您是孩子的？"
        placeholder="例如：爸爸"
      />
    ...
    <van-cell-group>
      ...
      <van-field
        v-model="childInfo.class"
        input-align="right"
        label="所在班级"
        placeholder="请输入班级,例如:向日葵一班"
      />
      <van-field
        v-model="childInfo.enterYear"
        input-align="right"
        label="入学年份"
        placeholder="请选择年份"
        @click="isPickerShow('year-month')"
      />
    </van-cell-group>
